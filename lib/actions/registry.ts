...
export const ACTIONS: readonly ActionSpec[] = Object.freeze([
  ...
  // ── الوصول والطلبات (10) ───────────────────────────────────────────
  { name: "addVehicle", ar: "إضافة سيارة (إدارة)", group: "access", kind: "write", capability: "VEHICLES", source: "spec",
    note: "✅ بُني. معتمَدة فوراً — الأدمن هو جهة الاعتماد، فاعتمادُ ما سجّله بنفسه نقرةٌ لا مراجعة." },
  { name: "registerMyVehicle", ar: "تسجيل الساكن مركبته", group: "access", kind: "write", capability: "VEHICLES", source: "spec",
    note: "✅ بُني. نطاق بنيويّ: المعرّف من الجلسة والشقة من ارتباطاته، وstatus ثابت PENDING_APPROVAL — قبولُه مُدخَلاً كان يمنح الساكن دخول البوّابة بلا مراجعة." },
  { name: "approveVehicle", ar: "الموافقة على سيارة", group: "access", kind: "write", capability: "VEHICLES", source: "spec", note: "✅ بُني." },
  { name: "rejectVehicle", ar: "رفض سيارة", group: "access", kind: "write", capability: "VEHICLES", source: "spec",
    note: "✅ بُني. السبب إلزاميّ: رفضٌ بلا سبب يجعل الساكن يعيد التسجيل نفسه فيُرفض ثانيةً." },
  { name: "removeVehicle", ar: "رفع مركبة", group: "access", kind: "write", capability: "VEHICLES", source: "audit", transactional: true,
    note: "✅ بُني. هو ما يُحرّر اللوحة لتسجيل جديد (S7) — والرفض لا يُحرّرها. ويُمنع مع باجٍ ساري: الرفع يُتيح اللوحة لغير صاحبها والباج يفتح البوّابة." },
  ...
  { name: "requestSubscriptionCancellation", ar: "طلب إلغاء اشتراك (ساكن)", group: "services", kind: "write", capability: "SUBSCRIPTIONS", source: "audit",
    note: "✅ بُني. الخيار (أ): عمودان على الصفّ (cancellationRequestedAt/Reason) لا حالة جديدة — الحالة كانت ستُخرجه من الفوترة بمجرّد الطلب، أي إلغاءٌ بلا قرار. ونطاقه بنيويّ كـrequestSubscription." },
  { name: "dismissCancellationRequest", ar: "ردّ طلب الإلغاء (إدارة)", group: "services", kind: "write", capability: "SUBSCRIPTIONS", source: "audit",
    note: "بدونه لا يملك من يقرّر الإبقاء إلا التجاهل، فيبقى العلم مرفوعاً وتصير شارة «إلغاء مطلوب» ضجيجاً لا إشارة." },
  { name: "requestProfileChange", ar: "طلب تعديل بيانات (ساكن)", group: "people", kind: "write", capability: "RESIDENT_PROFILES", source: "audit",
    note: "✅ بُني على ResidentRequest — الجدول كان بلا كاتب ولا قارئ. والهاتف داخلٌ فيه لأنه هويّة الدخول، والبريد مستثنى (مفتاح مطابقة Google). ونطاقه بنيويّ: المعرّف من الجلسة." },
  { name: "approveResidentRequest", ar: "تطبيق طلب تعديل (إدارة)", group: "people", kind: "write", capability: "RESIDENT_PROFILES", source: "audit", transactional: true,
    note: "✅ بُني. **يُطبّق** التغيير في نفس معاملة القرار — طلبٌ «مقبول» ببياناتٍ لم تتغيّر يجعل الساكن ينتظر رمزاً على رقمه القديم. وتفرّد الهاتف يُفحَص هنا ثانيةً." },
  { name: "rejectResidentRequest", ar: "رفض طلب تعديل (إدارة)", group: "people", kind: "write", capability: "RESIDENT_PROFILES", source: "audit",
    note: "✅ بُني. السبب إلزاميّ ويظهر للساكن في صفحة ملفّه." },
