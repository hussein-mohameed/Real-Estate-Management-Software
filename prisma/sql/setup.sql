-- ═══════════════════════════════════════════════════════════════════════
--  إعداد قاعدة البيانات كاملاً — نظام إدارة المجمّع السكني
--
--  الصق هذا الملف كلّه في:  Supabase → SQL Editor → New query → Run
--  يُنشئ: 37 نوعاً · 35 جدولاً · 96 فهرساً · 59 مفتاحاً أجنبياً
--         + 11 فهرساً فريداً جزئياً · 18 قيد CHECK · 4 triggers
--
--  ⚠️ صُمّم ليُشغَّل على قاعدة **فارغة**. آمن لإعادة التشغيل في قسم القيود
--     فقط (‏IF NOT EXISTS)، أما إنشاء الجداول فيفشل إن كانت موجودة — وهذا
--     مقصود: لا نريد أن يمرّ تشغيل ثانٍ صامتاً على قاعدة فيها بيانات.
--
--  بعد التشغيل، من جهازك:  npx prisma generate
-- ═══════════════════════════════════════════════════════════════════════
